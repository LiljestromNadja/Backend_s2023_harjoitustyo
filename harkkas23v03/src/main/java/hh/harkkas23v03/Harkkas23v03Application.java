...
/*
import hh.harkkas23v03.domain.ApplicationUser;
import hh.harkkas23v03.domain.ApplicationUserRepository;
import hh.harkkas23v03.domain.Article;
import hh.harkkas23v03.domain.ArticleRepository;
import hh.harkkas23v03.domain.Adtype;
import hh.harkkas23v03.domain.AdtypeRepository; */

@SpringBootApplication
public class Harkkas23v03Application {
	
//	private static final Logger log = LoggerFactory.getLogger(Harkkas23v03Application.class);

	public static void main(String[] args) {
		SpringApplication.run(Harkkas23v03Application.class, args);
		
		System.out.println("");


		
		System.out.println("Versio 03 (10-11-2023)");
