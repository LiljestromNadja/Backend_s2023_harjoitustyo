...
public class Harkkas23v06Application {
	
//	private static final Logger log = LoggerFactory.getLogger(Harkkas23v06Application.class);

	public static void main(String[] args) {
		SpringApplication.run(Harkkas23v06Application.class, args);
