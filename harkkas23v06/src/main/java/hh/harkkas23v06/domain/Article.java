...
public class Article {
	...
	public Article(
			long id, 
			@NotEmpty(message = "Anna ilmoitukselle kuvaava otsikko!") String title,
			@NotEmpty(message = "Anna myytävälle kohteelle kuvaus!") String description,
			String publisher, 
			String dateadded,
			@PositiveOrZero(message = "Tuotteen hinta on oltava 0 tai enemmän!") double price, 
			Adtype adtype, ApplicationUser applicationuser) {
		super();
		this.id = id;
		this.title = title;
		this.description = description;
