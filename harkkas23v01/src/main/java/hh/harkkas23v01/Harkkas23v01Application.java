...
/*
import hh.harkkas23v01.domain.ApplicationUser;
...
public class Harkkas23v01Application {
	
//	private static final Logger log = LoggerFactory.getLogger(Harkkas23v01Application.class);

	public static void main(String[] args) {
		SpringApplication.run(Harkkas23v01Application.class, args);
		
		System.out.println("");


		
		System.out.println("Versio 01 (09-11-2023)");
	...
	/*
	@Bean
	public CommandLineRunner demo(ArticleRepository repository, CityRepository crepository, ApplicationUserRepository urepository) {
		return(args) ->{
			
			City ykkonen =new City("IT");
			City kakkonen=new City("Ohjelmointi");
