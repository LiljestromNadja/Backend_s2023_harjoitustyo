...
public class ApplicationUser {
    ...
    */
	...
	@OneToMany(cascade = CascadeType.ALL, mappedBy = "applicationuser") //mappedByn pitää olla sama kuin Article.javassa private ApplicationUser applicationuser;
	@JsonIgnore
	...
	public String toString() {
		return "ApplicationUser [id=" + id + ", firstname=" + firstname + ", lastname=" + lastname + ", username="
				+ username + ", passwordHash=" + passwordHash + ", role=" + role + ", articles=" + articles + "]";
	}
