...
/*
import hh.harkkas23v05.domain.ApplicationUser;
...
public class Harkkas23v05Application {
	
//	private static final Logger log = LoggerFactory.getLogger(Harkkas23v05Application.class);

	public static void main(String[] args) {
		SpringApplication.run(Harkkas23v05Application.class, args);
		
		System.out.println("");


		
		System.out.println("Versio 05 (15-11-2023) --- Versio valmis");
		System.out.println("- sisältää Memon ja Kategorian many-to-many -suhteen + hallinnoimiseen CRUD");
