...
public class Article {
	...
	public Article(String title, String description, String publisher, String dateadded, int publicationYear,@PositiveOrZero(message = "Tuotteen hinta on oltava 0 tai enemmän!") double price, City city) {
		super();
		this.title = title;
		this.description = description;
		this.publisher = publisher;
	...
	public Article(long id, @NotEmpty(message = "Anna ilmoitukselle kuvaava otsikko!") String title,@NotEmpty(message = "Anna myytävälle kohteelle kuvaus!") String description,
			...
			@PositiveOrZero(message = "Tuotteen hinta on oltava 0 tai enemmän!") double price, City city, ApplicationUser applicationuser) {
		super();
		this.id = id;
		this.title = title;
		this.description = description;
